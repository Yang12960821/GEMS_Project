...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	if len(final_file_list)>0:
		...
		#只有1年的数据
		im_data,im_width,im_height,im_bands,im_geotrans,im_proj,NoDataValue=rasterinfo[0],rasterinfo[1],rasterinfo[2],rasterinfo[3],rasterinfo[4],rasterinfo[5],rasterinfo[6]
		im_data[im_data==NoDataValue]=-9999.0
	else:
	...
	mydataset.createDimension('time',1)
	...
	#时间序列，每年都一样
	data_variable=mydataset.createVariable(data_variable_name,'f4',('time','y','x'),fill_value=Fill_value)
	#对变量的单位进行设定
	...
	for i in range(len(times)):
		if data_variable.ndim==2:
			...
			#rasterdata[rasterdata==NoDataValue]=65535
			data_variable[:]=im_data	
		elif data_variable.ndim>2:
			#rasterdata=read_rasterfile(final_file_list[i])[0]
			#rasterdata[rasterdata!=NoDataValue]=rasterdata[rasterdata!=NoDataValue]*100
			#rasterdata[rasterdata==NoDataValue]=65535
			data_variable[i]=im_data
	...
	mydataset.setncattr('begin_date_(yyyy)','1992')
	mydataset.setncattr('end_date_(yyyy)','1992')
...
#单独年份
def create_NC_by_raster_single_year(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	final_file_list=[]
	read_all_files_inside_filepath(input_rasterfiles_path,input_rasterfiles_type,final_file_list)
	#降雨、温度需要排序
	#final_file_list.sort(key=list_sort_by_data)
	...
	#mydataset.createDimension('soil_layers_top',len(final_file_list))
	#mydataset.createDimension('soil_layers_bottom',len(final_file_list))
	#mydataset.createDimension('time',59)
	mydataset.createDimension('y',im_height)
	mydataset.createDimension('x',im_width)
	#char类型投影参数变量
	#mydataset.createDimension('Krasovsky_1940_Albers',1)
	...
	#只要1年的
	#data_variable=mydataset.createVariable(data_variable_name,'f4',('time','y','x'),fill_value=Fill_value)
	data_variable=mydataset.createVariable(data_variable_name,'f4',('y','x'),fill_value=Fill_value)
	#对变量的单位进行设定
	#times.standard_name='time'
	...
	for i in range(len(final_file_list)):
		if data_variable.ndim==2:
			...
			#rasterdata[rasterdata==NoDataValue]=65535
			data_variable[i]=im_data
		print_current_process(round((i+1)*1.0/len(final_file_list),2))
	#data_variable.scale_factor=Scale_factor
	#添加全局信息
	mydataset.title=filetitle
	mydataset.source='Ecohydrology Lab'
...
if __name__ == '__main__':
	#'''
	input_rasterfiles_path=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/initial/litterC/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/8.initial/new_single_year1992/initial_yrb1km_litterag_pbn_1992_dv01.nc4"
	data_variable_name='litterag'
	data_variable_longname="litter_aboveground_C"
	all_vars_units=['years since 1992','meters','meters','g C/m2']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Aboveground litter C for forest land"
	Scale_factor=1
	...
	input_rasterfiles_path=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/initial/standWood/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/8.initial/new_single_year1992/initial_yrb1km_woodStand_pbn_1992_dv01.nc4"
	data_variable_name='woodStand'
	data_variable_longname="standing_deadwood_C"
	all_vars_units=['years since 1992','meters','meters','g C/m2']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Standing deadwood C"
	Scale_factor=1
	create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle)



	input_rasterfiles_path=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/initial/liveabovegroundBiomass/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/8.initial/new_single_year1992/initial_yrb1km_livag_pbn_1992_dv01.nc4"
	data_variable_name='livag'
	data_variable_longname="live_aboveground_biomass"
	all_vars_units=['years since 1992','meters','meters','g C/m2']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Live aboveground biomass"
	Scale_factor=1
	create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle)



	input_rasterfiles_path=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/initial/livebelowgroundBiomass/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/8.initial/new_single_year1992/initial_yrb1km_livbg_pbn_1992_dv01.nc4"
	data_variable_name='livbg'
	data_variable_longname="live_belowground_biomass"
	all_vars_units=['years since 1992','meters','meters','g C/m2']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Live belowground biomass"
	Scale_factor=1
	create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle)
	...
	#'''
	input_rasterfiles_path=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/initial/downWood/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/8.initial/new_single_year1992/initial_yrb1km_wood2c_pbn_1992_dv01.nc4"
	data_variable_name='woodDown'
	data_variable_longname="down_deadwood_C"
	all_vars_units=['years since 1992','meters','meters','g C/m2']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Down deadwood C"
	Scale_factor=1
	create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle)
