...
if __name__ == '__main__':
	for gcm in ['CSIRO-Mk3.6']:
		for rcp in ['rcp26','rcp45','rcp85']:
			input_rasterfiles_path=u"B:/Data/6_GEMs未来气候数据delta降尺度/5CGCMs矫正降尺度_黄河流域2006_2010/"+gcm+"/tasmin/"+rcp+"/"
			input_rasterfiles_type='.tif'
			output_NC_file=u"B:/Data/6_GEMs未来气候数据delta降尺度/7YRB_Climate_NC/monthly_tmin_degC/Futuretmin2016_2100/"+gcm+"/"+rcp+"/climate_tmin_yrb1km_"+gcm+"_"+rcp+"_2016_2100_dv02.nc4"						
			data_variable_name='tmin'
			data_variable_longname='average minimum temperature'
			all_vars_units=['months since 2016','meters','meters','degrees C']
			begin_end_date=["2016-01","2100-12"]
			#Fill_value=0
			filetitle='Monthly Average Minimum Temperature'
			Scale_factor=1
