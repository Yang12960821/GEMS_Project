...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	if len(soil_layers_top)>1:
		data_variable=mydataset.createVariable(data_variable_name,'u2',('soil_layers_top','y','x'))
	else:
...
input_rasterfiles_path=u"H:/GEMS_Model_data/my_studyarea_data/raster_data/soil/soil_thick/YRB1km"
input_rasterfiles_type='.tif'
output_NC_file=u"H:/GEMS_Model_data/my_studyarea_data/nc4_data/2.soil/6.soil_thick/soil_thick_yrb1km_dv01.nc4"
