...
input_rasterfiles_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/soil/soil_silt/0_updated_silt/6层数据/"
input_rasterfiles_type='.tif'
output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/2.soil/2.soil_silt_updated/soil_silt_yrb1km_dv01.nc4"
data_variable_name='silt_ttl'
data_variable_longname="total silt"
all_vars_units=['cm','meters','meters','percent']
#begin_end_date=["0cm","200cm"]
begin_end_date=["1992","2015"]
#Fill_value=-3.40282346639e+038
filetitle="Gridded Total Silt for 6 Soil Layers"
Scale_factor=1
