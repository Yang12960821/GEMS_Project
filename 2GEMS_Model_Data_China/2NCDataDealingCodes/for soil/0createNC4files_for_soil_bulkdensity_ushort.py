...
if __name__ == '__main__':	
	input_rasterfiles_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/soil/soil_bulk_density/0_update_bd/g_cm_3/6层数据"
	input_rasterfiles_type='.tif'
	output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/2.soil/4.soil_bulk_density/soil_dbthirdbar_yrb1km_dv01.nc4"
	data_variable_name='dbthirdbar'
	data_variable_longname="DB 0.33 bar H20"
	all_vars_units=['cm','meters','meters','g/cm^3']
	#begin_end_date=["0cm","200cm"]
	begin_end_date=["1992","2015"]
	#Fill_value=-3.40282346639e+038
	filetitle="Gridded Dbthirdbar for 6 Soil Layers"
	Scale_factor=0.01
