...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	for i in range(len(times)):
		if data_variable.ndim==2:
			...
			#data_variable[(data_variable>17) or (data_variable<1)]=0
		print_current_process(round((i+1)*1.0/len(times),2))
	#data_variable[data_variable>17]=0
...
if __name__ == '__main__':
	input_rasterfiles_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/lucc/lulc_update_1_17/YRB_1992_2015_1km/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/1.lucc_all_corrected/lucc/landcover_lulc_yrb1km_1992_2015_dv01.nc4"
	data_variable_name='landcover'
	data_variable_longname='land cover ID -- using remapped land cover classes'
	all_vars_units=['years since 1992','meters','meters','LCTrends landcover values']
	begin_end_date=["1992","2015"]
	#Fill_value=0
	Scale_factor=1
	filetitle='Land Cover Data'
