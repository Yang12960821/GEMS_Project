...
if __name__ == '__main__':	
	#futurelulc
	input_rasterfiles_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/lucc/lulc_update_1_17/YRB_2020_2050_1km/RCP45/"
	input_rasterfiles_type='.tif'
	output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/1.lucc_all_corrected/lucc/FutureLulc/landcover_lulc_yrb1km_CGCM_rcp45_2016_2050_dv01.nc4"
	data_variable_name='landcover'
	data_variable_longname='land cover ID -- using remapped land cover classes'
	all_vars_units=['years since 2016','meters','meters','LCTrends landcover values']
