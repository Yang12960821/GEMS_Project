...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	final_file_list=final_file_list1*24
	#降雨、温度需要排序
	...
	for i in range(len(times)):
		if data_variable.ndim==2:
			...
			rasterdata[rasterdata!=0]=rasterdata[rasterdata!=0]+i
...
if __name__ == '__main__':
	...
	output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/6.forest/2.forest_ages/forest_standage_yrb1km_1992_2015_dv01.nc4"
	data_variable_name='stand_age'
	data_variable_longname="forest stand age"
	all_vars_units=['years since 1992-12','meters','meters','years']
