...
def create_NC_by_raster_2_variables(input_rasterfiles_1_path,input_rasterfiles_1_type,input_rasterfiles_2_path,input_rasterfiles_2_type,output_NC_file,data_variable1_name,data_variable2_name,data_variable_1_longname,data_variable_2_longname,all_vars_2vars_units,Scale_factor1,Scale_factor2,begin_end_date,filetitle):
	...
	#再存储数据的时候，需要先存放纬度，再存放精度
	if len(times)>1:
		data_variable1=mydataset.createVariable(data_variable1_name,'u4',('time','y','x'),fill_value=Fill_value1)
		data_variable2=mydataset.createVariable(data_variable2_name,'u4',('time','y','x'),fill_value=Fill_value2)
	else:
		data_variable1=mydataset.createVariable(data_variable1_name,'u4',('y','x'),fill_value=Fill_value1)
		data_variable2=mydataset.createVariable(data_variable2_name,'u4',('y','x'),fill_value=Fill_value2)
	#对变量的单位进行设定
	...
	for i in range(len(times)):
		if data_variable1.ndim==2:
			...
			imdata1[imdata1==NoDataValue1]=0
			imdata2[imdata2==NoDataValue2]=0
...
#构建2个变量的NC文件
input_rasterfiles_1_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/management/fertilizer/0YRB_Manure_1km_update/C_rate_gC_m2_1km"
input_rasterfiles_1_type='.tif'
input_rasterfiles_2_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/management/fertilizer/0YRB_Manure_1km_update/N_rate_gC_m2_1km"
input_rasterfiles_2_type='.tif'
output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/4.management/7.mgmt_manure/mgmt_manure_yrb1km_1992_2015_dv01.nc4"
