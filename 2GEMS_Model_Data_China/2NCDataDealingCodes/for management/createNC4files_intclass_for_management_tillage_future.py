...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	data_variable.flag_values=np.arange(0,5,1).astype(np.ubyte)
	#data_variable.flag_values=np.arange(1,18,1)
	data_variable.flag_meanings='0.no_tillage 1.ridge_tillage 2.mulch_tillage 3.reduced_tillage 4.conventional_tillage'
...
input_rasterfiles_path=u"H:/GEMS_Model_data/my_studyarea_data/raster_data/management/tillage/YRB_Crop_Tillage_1km_2016_2050/RCP2.6/"
input_rasterfiles_type='.tif'
output_NC_file=u"H:/GEMS_Model_data/my_studyarea_data/nc4_data/4.management/4.tillage/mgmt_tillage_yrb1km_CGCM_rcp26_2016_2050_dv01.nc4"
data_variable_name='tillage'
data_variable_longname='tillage type ID'
all_vars_units=['years since 2016-12','meters','meters','ID for represented_tillages']
begin_end_date=["2016","2050"]
#Fill_value=0
filetitle="Land Carbon Derived Tillage Type"
Scale_factor=1.0E-5
