...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	data_variable.flag_values=np.arange(0,2,1).astype(np.ubyte)
	#data_variable.flag_values=np.arange(1,18,1)
	data_variable.flag_meanings='0.non-irrigated 1.irrigated'
...
input_rasterfiles_path=u"H:/GEMS_Model_data/my_studyarea_data/raster_data/management/irrigated/YRB_irrigated_1km/"
input_rasterfiles_type='.tif'
output_NC_file=u"H:/GEMS_Model_data/my_studyarea_data/nc4_data/4.management/5.irrigated/mgmt_irrigation_yrb1km_dv01.nc4"
data_variable_name='irrigated'
data_variable_longname='irrigated or nonirrigated'
all_vars_units=['years since 1992-12','meters','meters','']
begin_end_date=["1992","2015"]
#Fill_value=0
filetitle="Irrigated or Nonirrigated Crop Pixels"
Scale_factor=1.0E-5
