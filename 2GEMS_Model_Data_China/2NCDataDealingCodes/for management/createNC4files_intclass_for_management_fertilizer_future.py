...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle):
	...
	#final_file_list=[final_file_list1[-1]]*35
	#降雨、温度需要排序
...
input_rasterfiles_path=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/raster_data/management/fertilizer/0YRB_Fertilizer_gN_m2_1km_update_2016_2050/"
input_rasterfiles_type='.tif'
output_NC_file=u"F:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/4.management/6.fertilizer/mgmt_fertilizer_yrb1km_CGCM_rcp26_2016_2050_dv01.nc4"
