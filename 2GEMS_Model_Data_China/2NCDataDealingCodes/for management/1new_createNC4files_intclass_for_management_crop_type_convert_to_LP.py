...
def create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle,LP_mask_ncfile):
	final_file_list=[]
	read_all_files_inside_filepath(input_rasterfiles_path,input_rasterfiles_type,final_file_list)
	#读取LP mask文件
	lp_mask_file=Dataset(LP_mask_ncfile)
	lp_mask_data=lp_mask_file.variables
	lp_mask=lp_mask_data['lpmask'][:]
...
if __name__ == '__main__':
	...
	output_NC_file=u"I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/nc4_data/4.management/1.mgmt_crop_type_and_lulc_update/mgmt_crop_type_yrb1km_1992_2015_dv01_LP.nc4"
	data_variable_name='crop'
	LP_mask_ncfile=u'I:/2GEMS/1GEMS_Model_Data_YRB/1YRB_data/黄土高原mask/lpmask.nc'
	...
	create_NC_by_raster(input_rasterfiles_path,input_rasterfiles_type,output_NC_file,data_variable_name,data_variable_longname,all_vars_units,Scale_factor,begin_end_date,filetitle,LP_mask_ncfile)
